...
<head>
	...
	-->
    <style type="text/css">
      body { padding-top: 40px; padding-bottom: 40px; background-image:url("<?=$this->config->item('base_url');?>ekids/css/bg.jpg");}
    ...
    <div class="">
      ...
      <div class="signin">
        <div class="signin-box">
          ...
          <a href="<?php echo site_url('register'); ?>" class="btn btn-primary " role="button">Register Now!</a>
